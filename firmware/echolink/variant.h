...
#define LORA_MISO 14 //14
#define LORA_SCK 12 //12
#define LORA_MOSI 13 //13
#define LORA_CS 11 //11

#define LORA_RESET 21 //21
#define LORA_DIO1 48 //48
...
#define BATTERY_PIN 8 // A battery voltage measurement pin, voltage divider connected here to measure battery voltage
